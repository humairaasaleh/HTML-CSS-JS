...
const ContactCardManager = () => {
    const arrayCard= [
        ...
        },
        {
            fname:"Alan",
            phone:"07837263384",
            image: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e0/Giraffa_camelopardalis_angolensis.jpg/1200px-Giraffa_camelopardalis_angolensis.jpg",
            quote:"dream big",
            address:"64 Zoo Lane"
        },
        {
            fname:"John",
            phone:"07838374748",
            image: "https://www.nationalworld.com/webimg/b25lY21zOjE3YjMxNmFjLWUxYTUtNGI5Ny04ODMwLWU2Njk4MzNmMDYyMjo5ZjZlMThiMy00MzRiLTQ1MWUtOWRhMC1hNTJmNTYyZGUzYTQ=.jpg?width=640",
            quote:"a cute quote",
            address:"19 Bath Road"
        },
        {
            fname:"Craig",
            phone:"07892836448", 
            image:"https://ychef.files.bbci.co.uk/live/624x351/p09g169z.jpg",
            quote:"another quote",
    ...
    return ( 
            <ContactCard arrayCard={arrayCard}/>
     );
}
